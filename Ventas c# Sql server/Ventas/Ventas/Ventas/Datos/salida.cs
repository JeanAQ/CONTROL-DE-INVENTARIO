...
namespace AccesoDato
{
...

    {
        ...
        public static void Registrarr(Entidades.salida ppEntidad)
        {
            ...
            var cmdC = new SqlCommand("sp_guuardar_salida", cn);

            var cmdD = new SqlCommand("SP_GUARDAR_DETALLE_SALIDA", cn);
            ...
            cmdC.Parameters.AddWithValue("@ID_SALIDA", ppEntidad.id_salida);
            ...
            try
            {
                ...
                foreach (var det in ppEntidad.Detalles)
                {
                    ...
                    cmdD.Parameters.AddWithValue("@ID_SALIDA", det.id_salida);
        ...
        public static void Registra(Entidades.salida ppEntidad)
            ...
            using (SqlConnection cn = new SqlConnection(conexion.LeerCC))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    foreach (var det in ppEntidad.Detalles)
                    {
                        ...
                        cmd.Parameters.AddWithValue("@ID_SALIDA", det.id_salida);
